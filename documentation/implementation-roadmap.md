...
| **4** | Persona & Customization | • Create `persona.json`<br>• Custom system prompt<br>• Set persona avatar & replace Chainlit UI logo<br>• Enable custom settings on Chainlit UI<br>• Enable TTS voice - Fish Audio| 4–8 hours |
